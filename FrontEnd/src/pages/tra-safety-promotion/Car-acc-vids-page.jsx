...
import { iframesarray2 as data } from "../../constants";
import { IframesGenerator } from "../../components";
import { Pagination } from "@mui/material";
import usePagination from "../../Pagination";

export default function CarAccVidsPage() {
          ...
          <div className="flex flex-col mt-[55px]">
            ...
            <div>
              <h3 className="text-[#006794] text-[18.856px] sm:text-[22px] font-semibold select-none text-center lg:text-start">
                Taichung car crash incident video
              </h3>
            </div>
          </div>
        </div>
